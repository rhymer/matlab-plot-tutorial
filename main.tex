...
\usepackage{color}
\usepackage{listings}
\input{lstMatlab.tex} % Defines the Matlab code listing style and commands.
...
%=========================================================================================
\input{mathMacro.tex}
\input{vectorMacro.tex}
\input{matrixMacro.tex}
%=========================================================================================
% Information
%=========================================================================================
...
\begin{figure}
    \centering
    \includegraphics[width=5cm]{quiver_gradient}
\end{figure}
